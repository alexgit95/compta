...
# ─── Stage 1 : Build ──────────────────────────────
FROM --platform=linux/arm64 eclipse-temurin:25.0.3_9-jdk-alpine AS build
...
FROM --platform=linux/arm64 eclipse-temurin:25.0.3_9-jdk-alpine AS extractor
...
FROM --platform=linux/arm64 eclipse-temurin:25.0.3_9-jre-jammy
